...
let director_name = "Praddep bhattarai"

console.log("lenght example")
...
//2.toLowerCase() -returns all string character to lowerCase
let genre = "Comedy"
...
let new_production_house=production_house.replaceAll(production_house,"Bluestone pic")
